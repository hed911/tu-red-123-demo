...
const handleShowDetail = () => setShowDetail(true);
	...
	const columnsReports = ['Código', '¿Quién reporta?', 'Afectada', 'Confiabilidad', 'Dirección', 'Descripición','Categoría', 'Subcategoría', 'Estado', 'Acciones']
	//AQUÍ IRÍA BIEN SEA UN METODO O UNA VARIABLE CON EL MAP DEL ARRAY DE DATOS
	const tbody = (			
					<tr>
					   <td className = "text-center">00001</td>
					   <td className = "text-center">Lina Marcela</td>
					   ...
					   <td className = "text-center">Pandemia</td>
					   <td className = "text-center"><span className = "badge badge-success">Cerrado</span></td>
					   <td className = "text-center">
					      <Dropdown>
...
export default AlertsHistorial