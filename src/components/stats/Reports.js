...
const options2 = {
    ...
    const options3 = {
        ...
        title: {
                text: 'Reportes por subcategoría',
                align: 'left'
        },
        dataLabels: {
            enabled: false
        ...
        <div className = "pt-5">
			<div className = "row">
				<div className = "col-md-12">
					<div className = "card">
						<h2 className = "pl-5 pt-4 font-weight-bold">Reportes</h2>
							...
							<div className = "row">
								<div className = "col-md-6">
									<div className="ds-stat">
			                            <span className="ds-stat-name">Porcentaje de reportes por categoría</span>
								...
								<div className = "col-md-6">
									<div className="ds-stat">
			                            <span className="ds-stat-name">Porcentaje de reportes por subcategoría</span>
